...
class NeuralNetwork:
    def __init__(self):
        self.model_file = "C:\\Users\\harsh\\OneDrive\\Documents\\Automatic_Number_Plate_Recognition-main[1]\\Automatic_Number_Plate_Recognition-main\\model\\binary_128_0.50_ver3.pb"
        self.label_file = "C:\\Users\\harsh\\OneDrive\\Documents\\Automatic_Number_Plate_Recognition-main[1]\\Automatic_Number_Plate_Recognition-main\\model\\binary_128_0.50_labels_ver2.txt"
...
if __name__ == "__main__":
    ...
    #cap = cv2.VideoCapture('C:\\Users\\User\\Documents\\GitHub\\number_plat_github_clone\\Automatic_NP_Detection_EasyOCR\\render3.mp4')
    cap = cv2.VideoCapture('C:\\Users\\harsh\\OneDrive\\Documents\\Automatic_Number_Plate_Recognition-main[1]\\Automatic_Number_Plate_Recognition-main\\input\\cctv_car_by_me_1.mp4')
    #cap = cv2.VideoCapture('C:\\Users\\User\\Downloads\\cctv_car_by_me3.mp4')
    #cap = cv2.VideoCapture('C:\\Users\\User\\Downloads\\170609_A_Delhi_026.mp4')
    while (cap.isOpened()):
        ret, img = cap.read()
        if ret == True:
            ...
            if possible_plates==None:
                ...
                if count1 >= 8:
                    ...
                    char_on_p=0
                if (char_on_p==1):
                    plt.imsave("C:\\Users\\harsh\\OneDrive\\Documents\\Automatic_Number_Plate_Recognition-main[1]\\Automatic_Number_Plate_Recognition-main\\Output\\image_{y}.png".format(y=yoyo),pre_final_image)
                if cv2.waitKey(25) & 0xFF == ord('q'):
                        break                   
